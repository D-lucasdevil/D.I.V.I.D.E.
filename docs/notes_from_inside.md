...
***What Are Pulses?***   
Pulses are intense bursts of reality distortion that occur exclusively when an anomaly first manifests or breaches into our reality. Think of them as a signature "rip" or "shockwave" in the fabric of space-time — the physical evidence of an anomaly's arrival.   

**Unique Event**: Each anomaly generates exactly one Pulse at the moment it enters our world, solar system, or dimension, depending on its size and power.   

**Magnitude Reflects Threat**: The strength and scale of the Pulse correlate directly to the anomaly's threat level. More dangerous anomalies cause more severe Pulses, causing greater disturbances across space and reality.  

**Detectable Phenomenon**: These Pulses can sometimes be recorded as sudden spikes in dimensional energy, unexplained sensor anomalies, or visible rips in reality itself.   

**Warning Signal**: Pulses serve as both a warning and a way to classify the incoming threat before the anomaly is fully contained or understood.   
  
**Rare and One-Time**: Because Pulses only occur at the point of manifestation, no further Pulses are generated by the same anomaly thereafter.   

In essence, Pulses are the universe's “arrival announcement” of an anomaly — a one-time, reality-shaking event that marks the beginning of a new threat.  
...
**Anomaly Pulse Levels**:  
**Pulse Level 1 — Minor Distortion**  
Corresponds to: Class I – Low Threat  
Description: Slight, barely noticeable ripples in reality. Often detected only by sensitive instruments. No immediate danger.  

**Pulse Level 2 — Noticeable Ripple**  
Corresponds to: Class II – Moderate Threat  
Description: Detectable dimensional pulses causing mild spatial disturbances. Usually stable but signals an active anomaly.  

**Pulse Level 3 — Severe Fluctuation**  
Corresponds to: Class III – High Threat  
Description: Strong reality disruptions manifesting as visible distortions or auditory anomalies. Can cause environmental interference and requires caution.  

**Pulse Level 4 — Critical Tear**  
Corresponds to: Class IV – Extreme Threat  
Description: Intense, violent rips in space-time. These pulses cause hazardous phenomena around the anomaly’s vicinity. Immediate containment necessary.  

**Pulse Level 5 — Catastrophic Rend**  
Corresponds to: Class V – Catastrophic Threat  
Description: Massive reality ruptures capable of large-scale destruction and erasure of physical or metaphysical elements. Signals an anomaly of global or universal threat.  

**Pulse Level 6 — Omega Surge**  
Corresponds to: Class VI – Omega-Class Threat  
Description: Uncontainable and omnipresent pulses disrupting multiple dimensions. These surges often precede apocalyptic events or interdimensional collapse.  
 
**Pulse Level Ω — The End Wave**  
Corresponds to: Class Ω – The End  
Description: The final, unstoppable pulse signaling total annihilation. All known laws break down; no containment or resistance possible.  
